...
//PYPEDIA REMOVE The following lines. Call to deprecated functions
//	global $wgMessageCache;
//	require_once( dirname( __FILE__ ) . '/ashighlight.i18n.php' );
//	foreach( efashighlightMessages() as $lang => $messages )
//		$wgMessageCache->addMessages( $messages, $lang );

//PYPEDIA Substitute with this
	global  $wgExtensionMessagesFiles;
	$wgExtensionMessagesFiles['ASHighlight'] = dirname( __FILE__ ) . '/ashighlight.i18n.php';
// \PYPEDIA
...
//PYPEDIA: Add links for keywords
	$out = preg_replace('/<span class="hl kwd">(\w+)<\/span>/i', '<span class="hl kwd"><a href="' . $wgServer . $wgScriptPath . '/index.php/${1}">${1}</a></span>', $out);
// \PYPEDIA
