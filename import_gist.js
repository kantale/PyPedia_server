			...
			function import_gist_2(button_pressed) {
				...
				url_textbox += "  Insert python functions that return True and print nothing if your class/function works properly (Unitests): <textarea id='ta_gist_uni' rows='8' cols='50'>def test_1(): \n    return True</textarea><p>";
