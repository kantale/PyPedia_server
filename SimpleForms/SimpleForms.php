...
define('SIMPLEFORMS_CONTENT',  'consghdh22SDFHshs2683tent');   # used for parsing wikitext content
...
//						document.getElementById('parameters_form').innerHTML += 'Enter password: <input type=\'password\' id=\'password_input\' name=\'wpl_password\'/><input type=\'submit\' value=\'GO!\' name=\'wpl_execute\'/>';
//                      		}";
